...
//             cout << d[tmp.first][tmp.second];
//             check = 1;
//             break;
//         }
//         if (maze[tmp.first - 1][tmp.second] == 0 && visited[tmp.first - 1][tmp.second] == 0) {
//             pair <int, int> abc;
//             abc.first = tmp.first - 1;
//             abc.second = tmp.second;
//             Q.push(abc);
//             visited[tmp.first - 1][tmp.second] = 1;
//             d[tmp.first - 1][tmp.second] = d[tmp.first][tmp.second] + 1;
//         }
//         if (maze[tmp.first + 1][tmp.second] == 0 && visited[tmp.first + 1][tmp.second] == 0) {
//             pair <int, int> abc;
//             abc.first = tmp.first + 1;
...
//             d[tmp.first + 1][tmp.second] = d[tmp.first][tmp.second] + 1;
//         }
//         if (maze[tmp.first][tmp.second - 1] == 0 && visited[tmp.first][tmp.second - 1] == 0) {
//             pair <int, int> abc;
//             abc.first = tmp.first;
//             abc.second = tmp.second - 1;
//             Q.push(abc);
//             visited[tmp.first][tmp.second - 1] = 1;
//             d[tmp.first][tmp.second - 1] = d[tmp.first][tmp.second] + 1;
//         }
//         if (maze[tmp.first][tmp.second + 1] == 0 && visited[tmp.first][tmp.second + 1] == 0) {
//             pair <int, int> abc;
//             abc.first = tmp.first;
